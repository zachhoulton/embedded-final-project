...
int mainj(void){ // joystick
  ...
  while(1){
    ...
    if(xpos>4000 && ypos>100 && ypos<4000){
      printf("Right\n"); 
    }
    if(xpos<3100 && xpos>3000 && ypos<2900 && ypos>2700){
      printf("Neutral\n");
    }
    if(xpos<100 && ypos>100 && ypos<4000){
      printf("Left\n");
    }
    if(xpos>3000 && xpos<3100 && ypos<100){
      printf("Up\n");
    }
    if(xpos>4000 && ypos<100){
      printf("Up-Right\n");
    }
    if(xpos<100 && ypos<100){
      printf("Up-Left\n");
    }
    if(xpos>4000 && ypos>4000){
      printf("Down-Right\n");
    }
    if(xpos<100 && ypos>4000){
      printf("Down-Left\n");
    }
    if(xpos>3000 && xpos<3100 && ypos>4000){
      printf("Down\n");
    }
    //Clock_Delay1ms(100); 
  }
